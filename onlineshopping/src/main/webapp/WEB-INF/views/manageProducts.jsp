               ...
               <!-- 	FORM ELEMENT -->
					...
					action="${contextRoot}/manage/products" method="POST" enctype="multipart/form-data">
						...
						<div class="form-group">
							...
							<div class="col-md-8">
								 <sf:textarea type="text" path="description" id="description" placeholder="Write a Description" class="form-control"></sf:textarea>
  	...
  	<div  class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				<!-- Category Form -->
				<sf:form modelAttribute="category" id="categoryForm" action="${contextRoot}/manage/category" class="form-horizontal" method="POST">
					<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-md-8 validate">
						  <sf:textarea cols="" rows="5" type="text" path="description" class="form-control"/>
						</div>
					</div>
